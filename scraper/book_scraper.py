...
class BookScraper:
    ...
    def parse_books(self, html, category, max_price=None):
        """Analiza el HTML y extrae datos de libros"""
        soup = BeautifulSoup(html, 'html.parser')
        books = []

        # Selectores específicos para books.toscrape.com
        selectors = {
    ...
    def scrape_category(self, category, pages=3, max_price=None):
        ...
        for page in range(1, pages + 1):
            ...
            if page == 1:
                url = f"{self.base_url}/catalogue/category/books/{category}_2/index.html"
            else:
                url = f"{self.base_url}/catalogue/category/books/{category}_2/page-{page}.html"
